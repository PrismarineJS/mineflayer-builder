...
class Build {
  ...
  getPossibleDirections (stateId, pos) {
    ...
    if (properties.facing) {
      const { facing, faceDirection } = this.getFacing(stateId)
      if (faceDirection) {
        if (facing === 'north') faces[0] = faces[1] = faces[3] = faces[4] = faces[5] = false
        else if (facing === 'south') faces[0] = faces[1] = faces[2] = faces[4] = faces[5] = false
        ...
        else if (facing === 'up') faces[0] = faces[2] = faces[3] = faces[4] = faces[5] = false
        else if (facing === 'down') faces[1] = faces[2] = faces[3] = faces[4] = faces[5] = false
      }
    }
